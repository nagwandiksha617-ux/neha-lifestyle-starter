...
const BASE_PATH = "/jewellery/bracelets";
const PARENT_CRUMBS = [
    { label: "Jewellery", to: "/jewellery" },
    { label: "Bracelets", to: BASE_PATH },
];

export const Route = createFileRoute("/jewellery/bracelets/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Bracelets" />;
  }
