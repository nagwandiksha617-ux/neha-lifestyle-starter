...
const SUBCATEGORY = "duffel-bags";
const BASE_PATH = "/travel-bags/duffel-bags";
const PARENT_CRUMBS = [
  { label: "Travel Bags", to: "/travel-bags" },
  { label: "Duffel Bags", to: BASE_PATH },
];

export const Route = createFileRoute("/travel-bags/duffel-bags/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Duffel Bags" />;
  }
