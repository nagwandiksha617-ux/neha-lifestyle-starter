...
const SUBCATEGORY = "large-travel-bags";
const BASE_PATH = "/travel-bags/large-travel-bags";
const PARENT_CRUMBS = [
  { label: "Travel Bags", to: "/travel-bags" },
  { label: "Large Travel Bags", to: BASE_PATH },
];

export const Route = createFileRoute("/travel-bags/large-travel-bags/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Large Travel Bags" />;
  }
