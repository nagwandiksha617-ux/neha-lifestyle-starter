...
const SUBCATEGORY = "travel-gym-bags";
const BASE_PATH = "/travel-bags/gym-bags";
const PARENT_CRUMBS = [
  { label: "Travel Bags", to: "/travel-bags" },
  { label: "Gym Bags", to: BASE_PATH },
];

export const Route = createFileRoute("/travel-bags/gym-bags/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Gym Bags" />;
  }
