...
const SUBCATEGORY = "travel-backpacks";
const BASE_PATH = "/travel-bags/travel-backpacks";
const PARENT_CRUMBS = [
  { label: "Travel Bags", to: "/travel-bags" },
  { label: "Travel Backpacks", to: BASE_PATH },
];

export const Route = createFileRoute("/travel-bags/travel-backpacks/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Travel Backpacks" />;
  }
