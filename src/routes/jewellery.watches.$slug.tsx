...
const BASE_PATH = "/jewellery/watches";
const PARENT_CRUMBS = [
    { label: "Jewellery", to: "/jewellery" },
    { label: "Watches", to: BASE_PATH },
];

export const Route = createFileRoute("/jewellery/watches/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Watches" />;
  }
