...
const SUBCATEGORY = "travel-bags";
const BASE_PATH = "/travel-bags/travel-bags";
const PARENT_CRUMBS = [
  { label: "Travel Bags", to: "/travel-bags" },
  { label: "Travel Bags", to: BASE_PATH },
];

export const Route = createFileRoute("/travel-bags/travel-bags/$slug")({
  head: ({ params }) =>
    buildProductHead({
...
function ProductRoute() {
  ...
  if (!product) {
    return <ProductNotFound backTo={BASE_PATH} backLabel="Back to Travel Bags" />;
  }
